...
for organization in org_dict:
    ...
    try:
        ...
        cur.execute("INSERT INTO githubtable (srno, company, total_contributions, unique_contributors, id, repo_name, date_range_parameter, date_of_run) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)",
                       (str(srno), str(organization), str(org_dict[organization]['total_contributions']), str(org_dict[organization]['unique_contributors']),str(org_dict[organization]['id']),str(org_dict[organization]['repo_name']),str(org_dict[organization]['date_range_parameter']),str(org_dict[organization]['date_of_run'])))
        connection.commit()
